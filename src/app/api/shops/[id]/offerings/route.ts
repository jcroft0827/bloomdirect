...
export async function GET(
    ...
    try {
        ...
        const offerings = await FulfillmentOffering.find({
            ...
            .sort({ sortOrder: 1, isDesignerChoice: -1, createdAt: 1 })
            .select(
                "type name slug description image occasion pricingTiers allowsSubstitutions isDefault isFeatured isDesignerChoice sortOrder proOnly taxable",
            )
            .lean();
